        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lastname = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DOB = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HomeLibraryId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimesRerented = table.Column<int>(type: "int", nullable: true),
                    RFID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BookId = table.Column<int>(type: "int", nullable: false),
                    BorrowerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    OriginLibraryId = table.Column<int>(type: "int", nullable: false),
                    CurrentLibraryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCopies_Libraries_CurrentLibraryId",
                        column: x => x.CurrentLibraryId,
                        principalTable: "Libraries",
                        principalColumn: "LibraryId");
                    table.ForeignKey(
                        name: "FK_BookCopies_Libraries_OriginLibraryId",
                        column: x => x.OriginLibraryId,
                        principalTable: "Libraries",
                        principalColumn: "LibraryId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BorrowedBookHistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    TimesRerented = table.Column<int>(type: "int", nullable: false),
                    BorrowerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BookCopyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowedBookHistories", x => x.BorrowedBookHistoryId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BorrowedBookHistories_BookCopies_BookCopyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsForeignBorrower = table.Column<bool>(type: "bit", nullable: false),
                    ExpirationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReservedCopyId = table.Column<int>(type: "int", nullable: false),
                    LibraryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCopies_CurrentLibraryId",
                table: "BookCopies",
                column: "CurrentLibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_BookCopies_OriginLibraryId",
                table: "BookCopies",
                column: "OriginLibraryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowedBookHistories_BookCopyId",
                table: "BorrowedBookHistories",
                column: "BookCopyId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowedBookHistories_BorrowerId",
                table: "BorrowedBookHistories",
                column: "BorrowerId");
